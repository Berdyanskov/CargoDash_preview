...
export function DeletableEdge({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, style, markerEnd, selected, data, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(BaseEdge, { id: id, path: path, markerEnd: markerEnd, style: {
                ...
                } }), _jsx("path", { d: path, fill: "none", stroke: "transparent", strokeWidth: 20, onMouseEnter: () => setHover(true), onMouseLeave: () => setHover(false), style: { pointerEvents: "stroke" } }), _jsxs(EdgeLabelRenderer, { children: [isBroadcast && (_jsx("div", { style: {
                            position: "absolute",
                            transform: `translate(-50%, -50%) translate(${labelX}px,${labelY - 14}px)`,
                            pointerEvents: "none",
                        }, className: "nodrag nopan", children: _jsx("span", { title: "Broadcast: this source's output is copied to every downstream on this port. Use Judge to route by condition instead.", className: "px-1.5 py-px rounded bg-amber-100 border border-amber-300 text-amber-800 text-[10px] font-medium leading-none whitespace-nowrap shadow-sm", children: "broadcast" }) })), _jsx("div", { onMouseEnter: () => setHover(true), onMouseLeave: () => setHover(false), style: {
                            position: "absolute",
