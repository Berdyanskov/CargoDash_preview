  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        varName: "augment",
        llmMode: true,
        // Code-mode placeholders required by the type — unused in LLM mode.
        mode: "sample",
        fnSource: "def fn(row):\n    return row\n",
        fnName: "fn",
        llmPrompt: "Please add an argument after the following sentence: {text}",
        llmOutputField: "text",
        llmClient: { mode: "modelRef", modelNodeId: "vllm_model" },
        llmGenKwargs: '{"temperature": 0.7}',
        intraBatchWorkers: 4,
        inputSchema: schema,
        outputSchema: schema,
      },
